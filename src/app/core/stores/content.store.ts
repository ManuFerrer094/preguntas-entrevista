...
const TECHNOLOGIES: Technology[] = [
  ...
  { id: 'dotnet', name: '.NET / ASP.NET', slug: 'dotnet', description: 'Plataforma de Microsoft para apps web y servicios', questionCount: 0, icon: 'code', devicon: 'devicon-dot-net-plain', color: '#512BD4', keywords: 'ASP.NET Core, Razor, Blazor, MAUI y Minimal API' },
