...
@Component({
    ...
    <div class="sidebar-card">
      ...
      <div class="related-list">
        @for (rq of relatedList; track rq.slug) {
          <a [routerLink]="['/', rq.technology, rq.slug]" [queryParams]="isAiMode ? { ai: 1 } : {}" class="related-item">
  ...
  styles: [`
    ...
    .related-title { font-size: 0.85rem; color: var(--app-text-muted); line-height: 1.4; }
    ...
    .view-all-link {
      font-size: 0.82rem; color: var(--app-primary);
...
export class RelatedQuestionsComponent {
  ...
  get technology(): string { return this.question?.technology ?? ''; }
