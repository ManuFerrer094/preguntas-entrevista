...
@Component({
  ...
  template: `
    ...
    @if (prUrl()) {
      ...
      <mf-card variant="outlined" padding="lg" class="login-card">
        ...
        <p>
          Para contribuir una pregunta necesitas autenticarte con tu cuenta de GitHub.<br />
          La Pull Request se creará bajo tu nombre de usuario.
        </p>
      ...
      <mat-stepper [linear]="true" #stepper class="contribute-stepper">
          ...
          <div class="step-content">
            <div class="field">
              <mf-select
                ...
                [error]="
                  step1.controls.technology.touched &&
                  step1.controls.technology.errors?.['required']
            ...
            <div class="field-row">
              <div class="field field-grow">
                <mf-input
                  ...
                  [error]="
                    step1.controls.title.touched && step1.controls.title.errors?.['required']
              ...
              <div class="field field-sm">
                <mf-select
                  ...
                  [error]="
                    step1.controls.difficulty.touched &&
                    step1.controls.difficulty.errors?.['required']
            ...
            <mf-form-field label="Tags" hint="opcional">
              @if (availableTags().length > 0) {
                <div
                  class="tags-selector"
                  role="group"
                  aria-label="Selecciona los tags de la pregunta"
                >
                ...
                <p class="tags-placeholder">
                  Selecciona una tecnología para ver los tags disponibles
                </p>
              }
            </mf-form-field>
          </div>
            ...
            <section class="editor-shell">
              <div class="editor-panel">
                ...
                <div
                  ...
                  role="toolbar"
                  aria-label="Controles de formato markdown"
                >
                  <button
                    type="button"
                    class="tool-btn"
                    (click)="applyInlineWrap('**', '**')"
                    title="Negrita"
                  >
                ...
                @if (
                  step2.controls.content.touched && step2.controls.content.errors?.['required']
                ) {
              ...
              <div class="preview-panel">
                ...
                <div class="preview-frontmatter">
                  <code>
                    ...
                    tags: [{{
                      step1.controls.tags.value || step1.controls.technology.value || 'tag1, tag2'
                    }}]<br />
        ...
        <mat-step>
            ...
            <mf-card variant="outlined" padding="lg" class="review-card">
              ...
              <div class="review-grid">
                ...
                <div class="review-item">
                  ...
                  <span
                    class="review-value review-badge"
                    [class]="'badge-' + step1.controls.difficulty.value"
                  >
                  ...
                  <div class="review-item review-item--full">
                    ...
                    <div class="review-tags">
                      @for (tag of selectedTags(); track tag) {
                        <span class="tag-chip tag-chip--selected tag-chip--sm">{{
                          tagLabel(tag)
                        }}</span>
                      }
                    </div>
                ...
                <div class="review-item review-item--full">
                  ...
                  <span class="review-value review-value--muted"
                    >{{ contentValue().length }} caracteres escritos</span
                  >
                </div>
              </div>
            </mf-card>
          ...
          <div class="step-actions step-actions--submit">
            <button
              type="button"
              class="nav-btn nav-btn--outlined"
              matStepperPrevious
              [disabled]="submitting()"
            >
              <mf-icon name="arrow_back" color="inherit" />
            ...
            <button type="button" class="submit-btn" (click)="onSubmit()" [disabled]="submitting()">
              @if (submitting()) {
  ...
  styles: [
    `
      ...
      .nav-btn--outlined:hover:not(:disabled) {
        background: var(--app-surface-raised);
      }
      .nav-btn--outlined:disabled {
        opacity: 0.45;
        cursor: not-allowed;
      }
...
export class ContributeComponent {
  ...
  onTechnologyChange(value: any): void {
    ...
    if (Array.isArray(value)) v = String(value[0]);
      ...
      v = String((value as any).value ?? (value as any).target?.value ?? value);
    else v = String(value ?? '');
  ...
  onSubmit(): void {
    ...
    this.http.post<{ prUrl: string }>('/api/submit-question', value, { headers }).subscribe({
      next: (res) => {
        this.prUrl.set(res.prUrl);
        this.submitting.set(false);
      },
      error: (err) => {
        const msg = err.error?.error ?? 'Error al enviar la pregunta. Inténtalo de nuevo.';
        this.error.set(msg);
        this.submitting.set(false);
      },
    });
