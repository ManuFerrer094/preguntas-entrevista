...
summary: "¿Qué revisarías en `Program.cs` o startup para detectar configuración, orden o middlewares problemáticos? en .NET: criterios sobre depuración y startup, erro..."
